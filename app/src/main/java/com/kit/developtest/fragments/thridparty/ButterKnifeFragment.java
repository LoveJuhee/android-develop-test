...
public class ButterKnifeFragment extends Fragment {
  ...
  @Bind(R.id.rbtnChk1) RadioButton rbtn1;
  @Bind(R.id.rbtnChk2) RadioButton rbtn2;
  @Bind(R.id.rbtnChk3) RadioButton rbtn3;
  @Bind(R.id.switch1) Switch switch1;
  @Bind(R.id.switch2) Switch switch2;
  @Bind(R.id.switch3) Switch switch3;
  ...
  @OnCheckedChanged({R.id.rbtnChk1, R.id.rbtnChk2, R.id.rbtnChk3, R.id.rbtnChk4})
